...
! Существует *pull request* - он дает возможность сделать предложение по изменению чьего-то репозитория, для этого нужно нажать fork на репозитории, который хотим изменить, сделать clone своей версии репозитория, изменить его, отправить его в свой удаленный репозиторий и нажать pull request.
